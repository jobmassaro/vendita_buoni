...
<div ng-controller="formCtrl">
    ...
    <ul class="nav nav-tabs" ng-repeat="tab in tabs.data">
        <li role="presentation"   ng-class="{ active: isSet(1) }" ng-if="tab.vandita_buoni !=0"><a href ng-click="setTab(1)">Vendita Buoni</a></li>
        ...
        <li  ng-class="{ active: isSet(16) }" ng-if="tab.report != 0"><a href ng-click="setTab(16)">Report</a></li>
