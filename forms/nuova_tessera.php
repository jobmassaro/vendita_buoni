...
<div ng-controller="nuovaTesseraCtrl">
  ...
  ?>
    ...
    <input name="barcode" type="text" class="required"  id="barcode" size="30" maxlength="16" ng-model="item.barcode" autofocus placeholder="barcode..codice fiscale"/ required></td>
  </tr>
  <tr>
    <td><label for="nome">Nome</label>		
</td>
    <td><input type="text" class="required" size="30"  ng-model="item.nome" placeholder="nome"/></td>
  </tr>
  <tr>
    <td><label for="cognome">Cognome</label>			
</td>
    <td><input type="text" id="cognome" class="required" size="30" onkeypress="" ng-model="item.cognome" placeholder="cognome"/></td>
  </tr>
  <tr>
    <td><label for="indirizzo">Indirizzo</label>				
</td>
    <td><input type="text" id="indirizzo" class="required" size="30" onkeypress="" ng-model="item.indirizzo" placeholder="indirizzo"/></td>
  </tr>
   <tr>
    <td><label for="civile">Numero Civico</label>				
</td>
    <td><input type="text" class="required" size="30" onkeypress="" ng-model="item.civico" placeholder="civico"/></td>
  </tr>
  <tr>
    <td><label for="comune">Comune</label>	
</td>
    <td><input type="text" name="comune"  id="comune" class="required" size="30" onkeypress="" ng-model="item.comune" placeholder="comune"/></td>
  </tr>
  <tr>
    <td><label for="cap">CAP</label>	
</td>
    <td><input type="text" name="cap"  id="cap" class="required" size="6" onkeypress="" ng-model="item.cap" placeholder="cap"/></td>
  </tr>
  <tr>
    <td><label for="prv">Provincia</label>
</td>
    <td><input type="text" name="prv"  id="prv" class="required" size="2" onkeypress="" ng-model="item.prv" placeholder="provincia"/></td>
  </tr>
  <?php if ($giococompleto->datanumero) { ?>
   <tr>
    <td><label for="nascita">Data di nascita</label>
</td>
    <td><input type="text" name="nascita"  id="nascita" class="required" size="11" onkeypress="" ng-model="item.nascita" placeholder="nascita"/></td>
  </tr>
 <?php }else{ ?>
   <tr>
    <td><label for="nascita">Data di nascita</label>
</td>
    <td><input type="text" name="nascita"  id="datepicker" class="required" size="11" onkeypress="" ng-model="item.nascita" placeholder="nascita"/></td>
  </tr>
 <?php } ?>
  <tr>
    ...
    <td>
      <select ng-model="item.sesso"  name="sesso">
  ...
  <tr>
    ...
    <td><input type="text" name="telefono"  id="telefono" class="required" size="30" onkeypress="" ng-model="item.telefono" placeholder="telefono"/></td>
  </tr>
  <tr>
    <td><label for="mobile">Cellulare</label>				
</td>
    <td><input type="text" name="mobile"  id="mobile" class="required" size="30" onkeypress="" ng-model="item.mobile" placeholder="mobile"/></td>
  </tr>
  <tr>
    <td><label for="email">Email</label>
</td>
    <td><input type="text" name="email"  id="email" class="required" size="30" onkeypress="" ng-model="item.email" placeholder="email"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<td>
  <select name="privacy" ng-model="item.privacy" convert-to-number name="privacy">
...
<select ng-model="item.privacy1" convert-to-number name="privacy1">
    <option value="1" >SI</option>
    <option value="0" selected>NO</option>
  </select>
</td>
