...
<div ng-controller="nuovaTesseraCtrl">
  ...
  <?php if ($giococompleto->datanumero) { ?>
   <tr>
    ...
    <td><input type="text" name="nascita"  id="nascita" class="required" size="11" onkeypress="return handleEnter(this, event)" ng-model="item.nascita" placeholder="nascita"/></td>
  </tr>
 <?php }else{ ?>
   <tr>
    <td><label for="nascita">Data di nascita</label>
</td>
    <td><input type="text" name="nascita"  id="datepicker" class="required" size="11" onkeypress="return handleEnter(this, event)" ng-model="item.nascita" placeholder="nascita"/></td>
  </tr>
 <?php } ?>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" name="telefono"  id="telefono" class="required" size="30" onkeypress="return handleEnter(this, event)" ng-model="item.telefono" placeholder="telefono"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="email" name="email"  id="email" class="required" size="30" onkeypress="return handleEnter(this, event)" ng-model="item.email" placeholder="email"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
