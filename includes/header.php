...
<link rel="shortcut icon" href="<?php echo $application; ?>/dist/images/favicon.png">
...
<!-- custom scripts -->
	<!--<script src="<?php // echo $application; ?>/dist/js/esterno.js"></script>-->
