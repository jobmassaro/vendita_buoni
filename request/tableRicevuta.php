...
{
    $controllobarcodeacquistatiTOT = Action::controlloBarcodeAcquistatiPeriodo ($barcode, $dbc);  
}
...
{
    $controllobarcodeacquistatiTOT = Action::controllobarcodeacquistati ($barcode, $dbc); 

} 
    

$controllobarcodeacquistati = $controllobarcodeacquistatiTOT->giocate;
$controllobarcodeacquistati1 = $controllobarcodeacquistatiTOT->giocate1;
$controllobarcodeacquistati2 = $controllobarcodeacquistatiTOT->giocate2;
...
if ($controlloresidui) 
{
    if ($totaleTOT > $residui) 
    {
        ...
        if ($giococompleto->codbar) { ?>
            IL CODICE FISCALE <?=$barcode?>  HA GIA' ACQUISTATO 
    <?php }else{ ?>
            IL BARCODE <?=$barcode?>  HA GIA' ACQUISTATO 
    <?php } 
