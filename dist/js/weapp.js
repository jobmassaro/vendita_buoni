        ...
        if(typeof(item) !== "undefined" && item !== null )
        {
               if(
                ...
                )
                {
                  ...
                  /*    if(item.nome==" " || typeof (item.nome) === "undefined" || typeof (item.nome) !== "" || typeof (item.nome) === null)
                       {
                             item.nome = "XXX";
                       }  
                       if(item.cognome===" " || typeof (item.cognome) === "undefined" || typeof (item.cognome) === "" || typeof (item.cognome) === null)
                       {
                             item.cognome = "XXX";
                       }  
                       if(item.indirizzo==" " || typeof (item.indirizzo) !== "undefined" || typeof (item.indirizzo) === "" || typeof (item.indirizzo) === null)
                       {
                             item.indirizzo = "XXX";
                       }  
                       if(item.civico==" " || typeof (item.civico) === "undefined" ||typeof (item.civico) === "" || typeof (item.civico) === null)
                       {
                             item.civico = "XXX";
                       }  
                       if(item.comune==" " || typeof (item.comune) === "undefined" ||typeof (item.comune) === "" || typeof (item.comune) === null)
                       {
                             item.comune = "XXX";
                       }  
                       if(item.cap==" " || typeof (item.cap) === "undefined" ||typeof (item.cap) === "" || typeof (item.cap) === null)
                       {
                             item.cap = "XXX";
                       }  
                       if(item.prv==" " || typeof (item.prv) === "undefined" || typeof (item.prv) === "" || typeof (item.prv) === null)
                       {
                             item.prv = "XXX";
                       }  
                        if(item.nascita==" " || typeof (item.nascita) === "undefined" ||typeof (item.nascita) === "" || typeof (item.nascita) === null)
                       {
                             item.nascita = "2017-05-30";
                       }  
                       if(item.sesso==" " || typeof (item.sesso) === "undefined" ||typeof (item.sesso) === "" || typeof (item.sesso) === null)
                       {
                             item.sesso = "XXX";
                       }  
                       if(item.telefono==" " || typeof (item.telefono) === "undefined" ||typeof (item.telefono) === "" || typeof (item.telefono) === null)
                       {
                             item.telefono = "XXX";
                       }  
                       if(item.mobile==" " || typeof (item.mobile) === "undefined" ||typeof (item.mobile) === "" || typeof (item.mobile) === null)
                       {
                             item.mobile = "XXX";
                       }  
                        if(item.email==" " || typeof (item.email) !== "undefined" ||typeof (item.email) === "" || typeof (item.email) === null)
                       {
                             item.email = "XXX";
                       } 
                        if(item.privacy ==" " || typeof (item.privacy) === "undefined" ||typeof (item.privacy) === "" || typeof (item.privacy) === null)
                       {
                             item.privacy = "1";
                       } 
                        if(item.privacy1==" " || typeof (item.privacy1) === "undefined" ||typeof (item.privacy1) === "" || typeof (item.privacy1) === null)
                       {
                             item.privacy1 = "0";
                       } */
